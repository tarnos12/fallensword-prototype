...
export const BOSSES = {
  ...
  ancientTerror: {
    ...
    lair: { zoneId: 'cindervein', x: 28, y: 28 }, // deepest tile of the endgame zone
  ...
  emberCalamity: {
    ...
    lair: { zoneId: 'cindervein', x: 2, y: 28 }, // opposite far corner from the Terror
  ...
  tribulationSovereign: {
    ...
    lair: { zoneId: 'thunderpeak', x: 38, y: 38 }, // storm-wracked summit, opposite the Cloudgate haven
